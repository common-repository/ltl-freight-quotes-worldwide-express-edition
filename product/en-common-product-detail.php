 ...
 * Class EnWweFreightProductCommonDetail
 * @package EnWweFreightProductCommonDetail
 */
if (!class_exists('EnWweFreightProductCommonDetail')) {
    ...
    class EnWweFreightProductCommonDetail
    {
        ...
        /**
         * Hook for call.
         * EnWweFreightProductCommonDetail constructor.
         */
        ...
        public function en_wwe_freight_plan_status($plan_status)
        {
            ...
            $insurance = apply_filters("wwe_quests_quotes_plans_suscription_and_features", 'insurance_fee');
            if (is_array($insurance)) {
                $plan_required = '1';
                $insurance_status = $en_plugin_name . ': Upgrade to Standard Plan to enable.';
            }

            $plan_status['insurance']['wwe_freight'][] = 'wwe_freight';
        ...
        public function en_app_common_plan_status()
        {
            ...
            if (isset($plan_status['insurance'])) {
                if (!in_array(0, $plan_status['insurance']['plan_required'])) {
                    ...
                    $this->insurance_plan_required = apply_filters("wwe_quests_plans_notification_link", [2, 3]);
    ...
    new EnWweFreightProductCommonDetail();
}