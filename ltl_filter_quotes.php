    ...
    class Ltl_Freight_Quotes
    {
        ...
        public function average_rate()
        {
            ...
            $rate[] = array(
                ...
                'origin_markup' => (isset($quotes_reset['origin_markup'])) ? $quotes_reset['origin_markup'] : 0,
                'product_level_markup' => (isset($quotes_reset['product_level_markup'])) ? $quotes_reset['product_level_markup'] : 0,
                'plugin_name' => 'wweLtl',
                'plugin_type' => 'ltl',
                'owned_by' => 'eniture'
            );
