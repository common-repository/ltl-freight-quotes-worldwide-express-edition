 ...
 * @return {wweLtlinstorePickupInputVal.instorePickup}
 */
if (typeof wweLtlinstorePickupInputVal != 'function') {
    function wweLtlinstorePickupInputVal(formID) {
 ...
 * @return {localDeliveryInputVal.localDelivery}
 */
 ...
 * @return {undefined}
 */
if (typeof wwe_ltl_load_inside_pikup_and_local_delivery_data != 'function') {
    function wwe_ltl_load_inside_pikup_and_local_delivery_data(data, formID) {
...
if (typeof wwe_ltl_en_wd_save_warehouse != 'function') {
    function wwe_ltl_en_wd_save_warehouse() {
        ...
        switch (true) {
            ...
            case (instore_pickup_fee && !/^[0-9]+(\.[0-9]{1,2})?$/.test(instore_pickup_fee)):
                jQuery('#add_warehouses #instore-pickup-fee').parent().find('.en_wd_err').text("In-store pick up fee format should be 100 or 100.20.");
                jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                return false;
        }
        ...
        var arrObj = [postForm, wweLtlinstorePickupInputVal(form_id), localDeliveryInputVal(form_id)];
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('.dropship_created').css('display', 'none');
                    window.location.href = jQuery('.close').attr('href');
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return wwe_ltl_en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return wwe_ltl_en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                } else {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    wwe_ltl_load_inside_pikup_and_local_delivery_data(data, "#add_warehouses");
                }
            },
        });
        return false;
...
if (typeof wwe_ltl_en_wd_save_dropship != 'function') {
    function wwe_ltl_en_wd_save_dropship() {
        ...
        const instore_pickup_fee = jQuery("#add_dropships #instore-pickup-fee").val();
        ...
        switch (true) {
            ...
            case (instore_pickup_fee && !/^[0-9]+(\.[0-9]{1,2})?$/.test(instore_pickup_fee)):
                jQuery('#add_dropships #instore-pickup-fee').parent().find('.en_wd_err').text("In-store pick up fee format should be 100 or 100.20.");
                jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                return false;
        }
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('.warehouse_created').css('display', 'none');
                    window.location.href = jQuery('.close').attr('href');
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return wwe_ltl_en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return wwe_ltl_en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                } else {
                    jQuery('.already_exist').show('slow');
                    jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                    setTimeout(function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    wwe_ltl_load_inside_pikup_and_local_delivery_data(data, "#add_dropships");
                }
            },
        });
        return false;
...
function stopSpecialCharacters(e) {
    ...
    // Allow: backspace, delete, tab, escape, enter and .
    if (jQuery.inArray(e.keyCode, [46, 27, 13, 110, 190, 53, 189]) !== -1 ||
        // Allow: Ctrl+A, Command+A
        (e.keyCode === 65 && (e.ctrlKey === true || e.metaKey === true)) ||
        // Allow: home, end, left, right, down, up
        (e.keyCode >= 35 && e.keyCode <= 40)) {
