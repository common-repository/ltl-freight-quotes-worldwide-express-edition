...
<script type="text/javascript">
    ...
    function change_warehouse_zip() {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-worldwide-express-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="form-btns">
                        <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form"
                               onclick="return wwe_ltl_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
