...
<div class="user_guide_fdo">
    ...
    <p>
        ...
        ) is a cloud-based, multi-carrier shipping platform that allows its users to create and manage postal, parcel,
        ...
        if (!$fdo_coupon_data['fdo_user']) {
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                <p>
                    ...
                    If you don’t have one, get freightdesk.online free for two months by using promo code
                    <strong>[<?php echo $fdo_coupon_data['coupon'] ?>]</strong>.

                </p>
                <p>
                    Click <a href="<?php echo $fdo_coupon_data['register_url'] ?>" target="_blank">here</a> to register
                    for freightdesk.online using the promo code now.
                    If you already connected then please click
                    <a href="javascript:void(0)" onclick="en_wwe_ltl_fdo_connection_status_refresh(this);">this link</a>
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-success">
                <p>
                    ...
                    <strong>[<?php echo $fdo_coupon_data['coupon'] ?>
                        ]</strong><?php echo $fdo_coupon_data['fdo_company_text'] ?>. Now you can enjoy free shipments
            ...
            <div id="message" class="en-coupon-code-div woocommerce-message en-coupon-notice">
                <p>
                    Note! Get FreightDesk Online free for two months by using promo code
                    <strong>[<?php echo $fdo_coupon_data['coupon'] ?>]</strong>.
                </p>
                <div class='en-coupon-btn-div'>
                    <button class="en_apply_promo_btn button"
                            data-coupon="<?php echo $fdo_coupon_data['coupon'] ?>"><?php _e('Apply Promo Code', 'woocommerce'); ?></button>
                </div>
            </div>
    ...
    if (get_option('en_fdo_company_id_status') != 1) {
        $button_connect = '<a href="javascript:void(0)" id="fd_online_id_wwe" class="button-primary">Connect</a>';
        ...
        if (get_option('en_fdo_company_id_status') == 1) {
            $button_connect = '<a href="javascript:void(0)" data="disconnect" id="fd_online_id_wwe" class="button-primary">Disconnect</a>';
