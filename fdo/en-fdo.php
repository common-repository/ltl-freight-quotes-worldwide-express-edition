...
class EnSpeedfreightFdo
{
    ...
    public function get_fdo_coupon_data_from_api(){
        ...
        $url = WWE_FREIGHT_FDO_COUPON_BASE_URL . "/use_coupon";
    ...
    public function get_fdo_coupon_parsed_data($fdo_coupon_data)
    {
        ...
        $parsed_data['register_url'] = WWE_FREIGHT_FDO_COUPON_BASE_URL.'/register?code='.$base64string;
        $parsed_data['login_url'] = WWE_FREIGHT_FDO_COUPON_BASE_URL.'/login?code='.$base64string;
        // $parsed_data['user_guide_get_started'] = WWE_FREIGHT_FDO_COUPON_BASE_URL.'/help/Getting_Started';
